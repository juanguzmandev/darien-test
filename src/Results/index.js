...
const Results = ({age, gender, nations}) => {
	return (
		<Fragment>
			<div className="flex flex-col items-center justify-center mx-2 my-6 p-4 rounded-lg shadow w-96 ">
			...
			<div className="w-96 flex flex-col items-center justify-center mx-2 my-6 p-4 rounded-lg shadow w-96 ">
